 ...
 */ function ReadSmore(element, options) {
   ...
   */ function truncate(el, idx) {
        ...
        const truncateContent = ellipse(originalContent, definedCount, isChars1(el));
        const originalContentCount = isChars1(el) ? _utils.getCharCount(originalContent) : _utils.getWordCount(originalContent);
 ...
 * @param {string}
 * @param {string}
 */ parcelHelpers.export(exports, "removeTags", ()=>removeTags
);
'use strict';
...
},{}],"ayeL7":[function() {},{}]},["kwnZB","86ByF"], "86ByF", "parcelRequire1eae")
