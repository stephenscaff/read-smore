   ...
   return {
     ...
     truncateText() {
       ...
       for (let i = 0; i < s.content.length; i++) {
         ...
         const truncateContent = ReadSmore.ellipseContent(originalContent, numberOfWords);
         const originalContentWords = ReadSmore.countWords(originalContent);
         ...
         if (numberOfWords < originalContentWords) {
           ...
           let self = i;
           ReadSmore.createLink(self)
         }
       }
       ReadSmore.handleClick(s.content);
     },
